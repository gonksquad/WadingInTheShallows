...
def runPipeline(image, llrobot):
    ...
    # **Display the contours as an intermediate step**
    ...
    # **Return the contour image instead of the original image**
    # This will display the contours as an intermediate step
